                               ...
                               Field *field, bool *error_reported)
{
  ...
  Parser_state parser_state;
  bool stored_in_db= field->vcol_info->stored_in_db;
  LEX *old_lex= thd->lex;
  LEX lex;
  LEX_STRING *vcol_expr= &field->vcol_info->expr_str;
  ...
  */
  ...
  /* restore the stored_in_db property, the parser doesn't generate it */
  field->vcol_info->stored_in_db= stored_in_db;
  ...
  */
  ...
  if (share->vfields || share->default_fields)
  {
    ...
    for (field_ptr= outparam->field; *field_ptr; field_ptr++)
    {
      ...
      {
        if (unpack_vcol_info_from_frm(thd, &outparam->mem_root, outparam,
                                      *field_ptr, &error_reported))
        {
